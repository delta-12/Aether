...
TEST_F(Aether, Task)
{
    ...
    std::uint8_t connect_message[] = {0x02U, 0x01U, 0x0AU, 0xCEU, 0xC2U, 0xF1U, 0x05U, 0x01U, 0x80U, 0x10U, 0xE8U, 0x07U, 0x00U};
    std::uint8_t accept_message[] = {0x0CU, 0x01U, 0x01U, 0xCEU, 0xC2U, 0xF1U, 0x05U, 0x02U, 0x80U, 0x10U, 0xFAU, 0x01U, 0x00U}; // TODO smaller MTU
